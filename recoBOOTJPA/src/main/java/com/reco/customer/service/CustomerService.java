	 ...
	 public void certifiedPhoneNumber(String phoneNumber, String numStr) {
	  ...
	  public String getAccessToken (String authorize_code) {
	        ...
	        try {
	            ...
	            sb.append("&redirect_uri=http://localhost:9998/recoBOOTJPA/kakaologin");
	  ...
	  public String getExitAccessToken (String authorize_code) {
	        String access_Token = "";
	        String refresh_Token = "";
	        String reqURL = "https://kauth.kakao.com/oauth/token";
	        ...
	        try {
	            ...
	            sb.append("grant_type=authorization_code");
	            sb.append("&client_id=2177f6a7b4ac54c3449ddca01ead7def");
	            sb.append("&redirect_uri=http://localhost:9998/recoBOOTJPA/kakaoexit");
	            sb.append("&code=" + authorize_code);
	            bw.write(sb.toString());
	            bw.flush();
